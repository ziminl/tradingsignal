...
# Disclaimer: This is an educational tool. Use it at your own risk.
# The contributors are not liable for any losses.

# Scores
trend = 0  # Scores higher than 0 indicate an uptrend
oversoldoverbought = 0  # Scores higher than 0 indicate oversold (might be a good time to buy)
buysell = 0  # Scores higher than 0 indicate a buy

exchange = ccxt.binanceus()  # List of supported exchanges can be found at https://github.com/ccxt/ccxt
...
# Convert to np array for readability with ta-lib
...
k, d = ta.STOCH(rsi, rsi, rsi, 14)  # Modified to match TradingView Stoch RSI values
